Привет! Я Full-Stack разработчик с опытом работы в различных областях, от веб-приложений до разработки микросервисов и мобильных приложений.  Я увлечен созданием эффективных и масштабируемых решений.
 ...
 Здесь представлены проекты, которые я разработал, используя различные языки программирования и технологии. Моя работа охватывает широкий спектр приложений, от автоматизации задач до разработки веб-приложений и API. Я стремлюсь к постоянному обучению и улучшению своих навыков.
