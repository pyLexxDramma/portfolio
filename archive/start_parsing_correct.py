#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Запуск парсинга с правильными настройками и сравнение результатов"""
...
print("="*80)
print("ЗАПУСК ПАРСИНГА С ПРАВИЛЬНЫМИ НАСТРОЙКАМИ")
print("="*80)
print("Компания: Смарт Хоум")
print("Сайт: http://smarthome.spb.ru")
print("Источник: BOTH")
print("Область поиска: Страна / общий поиск — города: Санкт-Петербург")
print("="*80)
